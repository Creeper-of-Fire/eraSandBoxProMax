...
namespace eraSandBox.Coitus
{
    ...
    {
        private readonly Dictionary<(string, string), object> _defs = new Dictionary<(string, string), object>();
        ...
        private static DefXml Instance { get; } = new DefXml(GetAllDefFile());
        ...
        private void LoadDef()
        {
            ...
            {
                object nodeDeSerialized = XmlUtility.DeSerializer(GetType().Namespace, defNode);
                this._defs.Add(
