...
public class LinkPoint<T>(int pointA, int pointB, T objectA, T objectB)
{
    /// <summary>
    ///     <see cref="pointA" />位于<see cref="objectA" />上
    /// </summary>
    public readonly T objectA = objectA;

    /// <summary>
    ///     <see cref="pointB" />位于<see cref="objectB" />上
    /// </summary>
    public readonly T objectB = objectB;

    public readonly int pointAPercentage = pointA;
    public readonly int pointBPercentage = pointB;


    public LinkPoint(Tuple<T, T, int, int> point) : this(point.Item3, point.Item4, point.Item1, point.Item2)
    {
    }
