...
namespace eraSandBox.Coitus
{
    ...
    /// </summary>
    [NeedDefInitialize]
    public class CoitusVaginaAspect : CoitusAspect, ILinkTo<CoitusVaginaAspect>
    {
        ...
        public new IList<LinkPoint<CoitusVaginaAspect>> linkTo
        {
            get
            {
                return base.linkTo.Select(
                    point => new LinkPoint<CoitusVaginaAspect>(LinkPoint<CoitusVaginaAspect>.ToPoint(point).ToTuple())).ToList();
            }
        }
